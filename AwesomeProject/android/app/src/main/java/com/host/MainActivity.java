...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Request();
        downDir = Environment.getExternalStorageDirectory() + "/zhenli/tmp";
        appDir = this.getFilesDir().getAbsolutePath();
        linearLayout = findViewById(R.id.container);

        getHomeInfo();
    }
    //@RequiresApi(api = Build.VERSION_CODES.M)
    private void Request() {             //获取相机拍摄读写权限
    ...
    private void getHomeInfo() {
        ...
        Request request = new Request.Builder().url(SERVER_URL+"/home").method("GET", null).build();
                        ...
                        public void run() {
                            ...
                            button.setOnClickListener(new View.OnClickListener() {
                                ...
                                public void onClick(View v) {
                                    ...
                                    String f = appDir + "/" + bundle.name + "/" + bundle.name + ".bundle";
    ...
    private void download(final String bundleName) {
        ...
        FileDownloader.getImpl().create(SERVER_URL+"/download/bundle/" + bundleName).setPath(downDir, true)
                ...
                .setListener(new FileDownloadListener() {
                    ...
                    protected void completed(BaseDownloadTask task) {
                        ...
                        try {
                            //下载之后解压，然后打开
                            ZipUtils.unzip(MainActivity.this.downDir + "/" + bundleName + ".zip", MainActivity.this.appDir);
